...
class TextFormFieldDemoState extends State<TextFormFieldDemo> {
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      ...
      showInSnackBar('Por favor informe os dados antes de enviar.');
    } else {
      form.save();
      showInSnackBar('${person.name}\'s o telefone é ${person.phoneNumber}');
    }
  }
...
////                ),
                ...
                new PasswordField(
                  ...
                  helperText: 'Máximo de 8 caracteres.',
                  labelText: 'Senha *',
